...
public class State implements Parcelable {
    ...
    public void setBatVoltage(Integer batVoltageltage) {
    ...
    protected State(Parcel in) {
        ...
        this.batVoltage = (Integer) in.readValue(Integer.class.getClassLoader());
        ...
        this.realTime = (Integer) in.readValue(Integer.class.getClassLoader());
